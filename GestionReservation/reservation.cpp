...
QSqlQueryModel* reservation::rechercherno(QString id)
{          QSqlQuery query ;
           query.prepare("SELECT * FROM RESERVATION WHERE NOMRES=:NOMRES");
                  query.bindValue(":NOMRES",id);
                         query.exec();
    QSqlQueryModel * model = new QSqlQueryModel();
            model->setHeaderData(0, Qt::Horizontal, QObject::tr("Nom"));
            model->setHeaderData(1, Qt::Horizontal, QObject::tr("Prenom"));
...
QSqlQueryModel* reservation::rechercherty(QString id)
{          QSqlQuery query ;
           query.prepare("SELECT * FROM RESERVATION WHERE TYPERES=:TYPERES");
                  query.bindValue(":TYPERES",id);
                         query.exec();
    QSqlQueryModel * model = new QSqlQueryModel();
            model->setHeaderData(0, Qt::Horizontal, QObject::tr("Nom"));
            model->setHeaderData(1, Qt::Horizontal, QObject::tr("Prenom"));
